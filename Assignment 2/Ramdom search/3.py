...
def random_search(x_values, y_values, iterations=1000, depth=5,pop=100):
    ...
    write_data_to_file(str(best_score_List), "3_score.txt")
    write_data_to_file(str(best_tree_list), "3_tree.txt")
...
def hill_climbing(x_values, y_values, iterations=1000, depth=4, mutation_depth=4, pop=100):
    ...
    write_data_to_file(str(best_score_List), "3_score")
    write_data_to_file(str(best_tree_list), "3_tree")
